package Dist::Zilla::Plugin::BumpVersionAfterRelease::Pod;
use 5.008001;
use strict;
use warnings;
...
sub rewrite_version {
    ...
    if (!$content =~ m{\Aour \$VERSION = '(.*)';}) {
        $self->log_debug( [ q[], $file, $version ]);
    }
        my $version = 
    }
